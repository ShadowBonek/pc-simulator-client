...
// !JSON RESET TEMPLATE
const template = componentSelectedTemplate["mobo"];
...
const Filter = (props: props) => {
  ...
  // !UseEffect
  useEffect(() => {
    //     setState({ ...props.queries, socket: app.socket.toLowerCase() });
    setState(props.queries);

    setQueriesTemplate({
      ...props.queriesTemplate,
      socket:
        app.socket.toLowerCase() === "lga1700"
          ? ["", "lga1700"]
          : app.socket.toLowerCase() === "am4"
          ? ["", "am4"]
          : ["", "lga1700", "am4"],
    });
  }, []);
