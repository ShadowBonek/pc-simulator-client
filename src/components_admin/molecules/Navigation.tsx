  ...
  return (
    <NavigationSt>
      <NavLink className="navLink" to={`/`}>
        <GiComputerFan className="sysIconNav" />
        <span className="text none">Simulator</span>
      </NavLink>
      <NavLink className="navLink" to={`/admin/components/cpu?page=1&search=&available=&manufacturer=`}>
